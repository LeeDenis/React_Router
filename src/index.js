...
//       <div>
//         <h1>Sudoku</h1>
//         <p>Sudoku is a recently popularized number-based grid game </p>
//         <p>It's even better when you can switch between those URLs with ease and share them with friends and family</p>
//       </div>
//     );
//   }
...
//       <div>
//         <h1>History</h1>
//         <p>Tic-tac-toe is a grid-based game with the objective of getting three items in a row.</p>
//         <p>Variations of games involving the same concept date as far back as 3,300 years ago, in ancient Egypt.</p>
//       </div>
//     );
//   }
// }
